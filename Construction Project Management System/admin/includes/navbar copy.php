...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    ...
    <div class="sidebar-brand-text mx-2 mt-2 text-uppercase text-warning"><h1>seas<sup>226</sup></h1></div>
</a>
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Sample:</h6>
...
<li class="nav-item">
    ...
    <div id="collapseProject" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">Projects</a>
            <a class="collapse-item" href="cards.html">Employees</a>
            <a class="collapse-item" href="cards.html">Daily Logs</a>
            <a class="collapse-item" href="Daily Logs.html">Work Orders</a>
            <a class="collapse-item" href="cards.html">Tools/Equipments</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseinventory" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">Tools</a>
            <a class="collapse-item" href="cards.html">Equipments</a>
            <a class="collapse-item" href="Daily Logs.html">Materials</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseDocu" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="cards.html">Sales</a>
            <a class="collapse-item" href="cards.html">Employee log</a>
            <a class="collapse-item" href="cards.html">Payroll</a>
        </div>
    </div>
</li>
...
<div class="sidebar-card d-none d-lg-flex">
    ...
    <p class="text-center mb-2"><strong>Have a question?</strong> </p>
    <a class="btn btn-success btn-sm" href="https://web.facebook.com/?_rdc=1&_rdr">Message Us!</a>
</div>
